...
def generate_backlog_markdown(
    ...
    """Generate a markdown backlog from analysis outputs."""
    lines: list[str] = []
...
def write_backlog(
    ...
    """Write the generated backlog markdown into docs."""
...
def update_instruction_file(
    ...
    """Insert auto-generated insight hints into instruction markdown."""
...
def render_instruction_markdown(current: str, top_sources: list[str]) -> str:
    """Render instruction markdown with an updated auto-insights block."""
