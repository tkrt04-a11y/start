...
def test_write_ops_report_creates_markdown_and_html_outputs(tmp_path):
        ...
        "failed_command_retry_guides": [
            {
                ...
                "runbook_reference": "docs/runbook.md#daily-pipeline",
                "runbook_reference_anchor": "#daily-pipeline",
            }
        ],
    }
    ...
    assert "runbook_reference: [docs/runbook.md#daily-pipeline](docs/runbook.md#daily-pipeline)" in text
    assert "runbook_reference_anchor: #daily-pipeline" in text
